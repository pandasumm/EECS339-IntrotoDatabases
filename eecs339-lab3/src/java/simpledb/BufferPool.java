...
public class BufferPool {
    ...
    public  Page getPage(TransactionId tid, PageId pid, Permissions perm)
        ...
        Page p = Database.getCatalog().getDatabaseFile(tableid).readPage(pid);
        pages.put(pid, p);
        return p;
    	//return null;
    }
    ...
    */
    ...
    private synchronized  void evictPage() throws DbException {
        ...
        // not necessary for lab1
    	// FIFO Policy
    	// try to evict the first page, focusing on finding that is not dirty
    	...
    	if (!isevict)
    		throw new DbException("evictPage fail.");
    }
