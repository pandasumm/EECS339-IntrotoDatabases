...
public class BufferPoolWriteTest extends TestUtil.CreateHeapFile {
    ...
    class HeapFileDuplicates extends HeapFile {
    	...
    	public ArrayList<Page> insertTuple(TransactionId tid, Tuple t)
    		...
    		for(int i = 0; i < duplicates; i++) {
    			// create a blank page
    			//System.out.println("new a page in heapfile, hpid: " + super.numPages());
    ...
    @Test public void insertTuple() throws Exception {
        ...
        for (int i = 0; i < 504; ++i) {
        	...
        	// System.out.println("numslots: " + p.numSlots);
        	...
        	// System.out.println("test numslots: " + p.numSlots + " empty " + p.getNumEmptySlots());
    ...
    @Test public void handleManyDirtyPages() throws Exception {
    	...
    	System.out.println("handle many dirties");
